...
interface MlbStatsApi {
     ...
     */
    fun getPeopleChangesResponse(
        peopleChangesRequiredQueryParams: PeopleChangesRequiredQueryParams,
        peopleChangesOptionalQueryParams: PeopleChangesOptionalQueryParams = PeopleChangesOptionalQueryParams()
     ...
     */
    fun getSportsPlayersResponse(
        sportsPlayersRequiredQueryParams: SportsPlayersRequiredQueryParams,
        sportsPlayersOptionalQueryParams: SportsPlayersOptionalQueryParams = SportsPlayersOptionalQueryParams()
    ): SportsPlayersResponse

    /**
     * Endpoint "standings"
     */
    fun getStandingsResponse(
        standingsRequiredQueryParams: StandingsRequiredQueryParams,
        standingsOptionalQueryParams: StandingsOptionalQueryParams = StandingsOptionalQueryParams()
    ): StandingsResponse
